...
#
# Program: initpost.sh
# Author:  Vitor Britto changed by Marcos Oliveira
...
POST_NAME=$( echo $POST_NAME | sed 'y/áÁàÀãÃâÂéÉêÊíÍóÓõÕôÔúÚüÜçÇ/aAaAaAaAeEeEiIoOoOoOuUuUcC/' | tr -d ',.;:');
...
# Set your blog URL
BLOG_URL="http://terminalroot.com.br"
